$(document).ready(function () {
    ...
    $(document).on("click", ".delete", function (e) {
        ...
        $.confirm({
            ...
            content: 'Are you sure that you want to delete this service?',
            type: 'red',
            typeAnimated: true,
            buttons: {
                Yes: {
                    ...
                    action: function () {
                        $.ajax({
                            type: 'POST',
                            url: '/admin/dashboard/service-delete',
                            data: {
                                _token: token,
                                id: id,
                            },
                                    ...
                                    $.confirm({
                                        ...
                                        buttons: {
                                            tryAgain: {
                                                ...
                                                btnClass: 'btn-green',
                                                action: function () {
                                                    window.location.replace('/admin/dashboard/service-index');
                                                }
                                            },
                                        }
                                    });
    ...
    $(document).on("click", ".activate-deactivate", function (e) {
        ...
        $.ajax({
            type: 'POST',
            url: '/admin/dashboard/service-activate-deactivate',
            data: {
                _token: token,
                id: model_id,
            },
            ...
            buttons: {
                Yes: {
                    ...
                    action: function () {
                        $.ajax({
                            type: 'POST',
                            url: '/admin/dashboard/service-profile-delete-image',
                            data: {
                                _token: token,
                                id: id,
                            },
