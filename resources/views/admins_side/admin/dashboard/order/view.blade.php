...
<div class="content-wrapper">
    ...
    <section class="mt-3 content text-dark center">
        <div class="container m-5 p-5">
            ...
            <div class="d-flex justify-content-between align-items-center position-relative mb-4" style="border-bottom: 2px solid #e9ecef;">
                @foreach ($stepStatuses as $code => $label)
                    ...
                    <div class="text-center flex-fill">
                        <div class="rounded-circle {{ $circleClass }} mx-auto mb-2" style="width: 30px; height: 30px; line-height: 30px;">
                            {{ $index }}
                        </div>
