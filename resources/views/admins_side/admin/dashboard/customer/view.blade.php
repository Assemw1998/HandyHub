...
<div class="content-wrapper">
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    <a href="{{ route('admin.dashboard.customer-index')}}">Customer</a>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
    ...
    <section class="mt-3 content text-dark center">
        <div class="col-12 col-lg-6 p-0 mb-2">
            <a class="btn btn-outline-success  col-lg-3 col-12 update mb-2" href="{{ route('admin.dashboard.customer-update-view',['id' => $customer->id])}}" data-id="">Update</a>
            <a class="btn btn-outline-danger col-lg-3 col-12 delete mb-2" data-id="{{$customer->id}}">Delete</a>
            <a class="btn btn-outline-info col-lg-3 col-12 mb-2 activate-deactivate" data-id="{{$customer->id}}">{{($customer->status?'Deactivate':'Activate')}}</a>
        </div>
            ...
            <li class="list-group-item">
                <div class="form-group">
                    ...
                    <span class="
                        ...
                        @else bg-danger
                        @endif p-1">
                        {{$customer->status_label}}</span></div>
                </div>
            </li>
            <li class="list-group-item">
                <div class="form-group">
