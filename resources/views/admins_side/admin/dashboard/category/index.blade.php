...
<div class="content-wrapper">
    ...
    <section class="mt-3 content text-dark center">
        <div class="row col-12 text-right mb-4">
            <a href="{{ route('admin.dashboard.category-create-view')}}" class="btn btn-outline-primary">Add New Category</a>
        </div>
                ...
                <tbody>
                    @foreach($categories as $category)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.dashboard.category-view',['id' => $category->id])}}" class="btn btn-outline-info  view d-block m-2" data-id=""><i class="fa fa-eye"></i></a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
